package store.web.rest.exception;
...
import store.service.authentication.exception.EmailExistsException;
import store.service.user.exception.UserNotFoundException;
import store.util.HttpUtil;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> handleConflictException(HttpServletRequest httpServletRequest,
        ...
        final Locale locale = HttpUtil.getLocaleFromHeader(httpServletRequest);
